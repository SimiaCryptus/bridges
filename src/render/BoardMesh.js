...
export class BoardMesh extends THREE.Mesh {
  constructor(board, theme) {
    ...
    const own = new Float32Array(count),
      ct = new Float32Array(count);
    const cid = new Float32Array(count),
      st = new Float32Array(count),
      cc = new Float32Array(count * 2);
    const rm = new Float32Array(count),
      cn = new Float32Array(count);
  ...
  setHover(id) {
    this.material.uniforms.uHoverCell.value = id;
  }
