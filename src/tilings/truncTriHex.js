...
const dodV = (k) => {
  const a = Math.PI / 12 + (Math.PI / 6) * k;
...
export default {
  ...
  protoTiles: [
    ...
    { kind: 'square', poly: square(0) },
    { kind: 'square', poly: square(1) },
    { kind: 'square', poly: square(2) },
    { kind: 'hex', poly: hexagon(0) },
    { kind: 'hex', poly: hexagon(1) },
  ],
